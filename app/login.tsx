import { View, Text, TouchableOpacity, StyleSheet, TextInput, Image, SafeAreaView, KeyboardAvoidingView, Platform } from 'react-native'
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.companyName}>BusTracker Pro</Text>
        </View>
